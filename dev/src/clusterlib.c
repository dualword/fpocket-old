...
/*
    printf("%f, %f, %f  vs  %f %f %f\t",data1[index1][0],data1[index1][1],data1[index1][2],data2[index2][0],data2[index2][1],data2[index2][2]);
*/
  }
  else
  { for (i = 0; i < n; i++)
...
The cuttree_distance routine takes the output of a hierarchical clustering routine, and
divides the elements in the tree structure into clusters based on the
hierarchical clustering result. The distance is specified by the user.
