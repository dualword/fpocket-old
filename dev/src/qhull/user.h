...
This file was modified by Peter Schmidtke and Vincent Le Guilloux on 
09/10/2010 to set default precision to floating point.
The macro REALfloat has thus been defined to 1 by default, as fpocket
do not need double precision.
