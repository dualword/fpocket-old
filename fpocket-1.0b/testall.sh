...
./bin/tpocket -L data/pp-cplx-t.txt -D $D -m $m -M $M -i $i -n $n -v $v
...
./bin/tpocket -L data/pp-apo-t.txt -D $D -m $m -M $M -i $i -n $n -v $v
...
./bin/tpocket -L data/cheng-t.txt -D $D -m $m -M $M -i $i -n $n -v $v
...
./bin/tpocket -L data/astex-diverse-t.txt -D $D -m $m -M $M -i $i -n $n -v $v
...
./bin/tpocket -L data/train-t.txt -D $D -m $m -M $M -i $i -n $n -v $v
...
./bin/tpocket -L data/ccdc-clean-t.txt -D $D -m $m -M $M -i $i -n $n -v $v
