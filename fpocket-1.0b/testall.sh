...
./bin/tpocket -L data/pp-cplx-t.txt -D $D -m $m -M $M -i $i -n $n 
...
./bin/tpocket -L data/pp-apo-t.txt -D $D -m $m -M $M -i $i -n $n 
...
./bin/tpocket -L data/train-t.txt -D $D -m $m -M $M -i $i -n $n 
...
./bin/tpocket -L data/cheng-t.txt -D $D -m $m -M $M -i $i -n $n 
...
./bin/tpocket -L data/gold-t.txt -D $D -m $m -M $M -i $i -n $n 
mv stats_g.txt stats_g_gold.txt
mv stats_p.txt stats_p_gold.txt
mv stats_g_gold.txt $out
mv stats_p_gold.txt $out

echo "== Testing astex diverse set"
./bin/tpocket -L data/astex-diverse-t.txt -D $D -m $m -M $M -i $i -n $n 
